...
int main(void)
{
    ...
    while (1)
    {
        ...
        case 16: // Enter any location
            ...
            bool notUsed = convertToLocal(&hours, &year, &month, &day, lon, true, doDST, whereDST, &UTCOffset);
        ...
        bool notUsed1 = convertToLocal(&riseI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        // Convert UTC sunset time to local sunset time
        bool notUsed2 = convertToLocal(&setI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        ...
        bool notUsed3 = convertToLocal(&civ_startI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        // Convert UTC civ_end time to local civ_end time
        bool notUsed4 = convertToLocal(&civ_endI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        ...
        bool notUsed5 = convertToLocal(&naut_startI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        // Convert UTC naut_end time to local naut_end time
        bool notUsed6 = convertToLocal(&naut_endI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        ...
        bool notUsed7 = convertToLocal(&astr_startI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
        // Convert UTC astr_end time to local astr_end time
        bool notUsed8 = convertToLocal(&astr_endI, &year, &month, &day, lon, false, doDST, whereDST, &UTCOffset);
